    ...
    public static class DependencyInjectionExtensions
    {
        public static IServiceCollection AddDatabase(this IServiceCollection serviceCollection, IConfiguration configuration)
        {
            return serviceCollection.AddScoped<IDbConnection>(options => 
                    new NpgsqlConnection(configuration.GetConnectionString("BookStoreDb")));
        }

        public static IServiceCollection AddRepositories(this IServiceCollection serviceCollection)
        {
            return serviceCollection.AddScoped<IAuthorRepository, AuthorRepository>()
        ...
        {
            return serviceCollection.AddTransient<IAuthorService, AuthorService>()
